...
DECLARE @Result VARCHAR(MAX) = 'using TestDataFramework;
...
SELECT @Result = @Result +
	...
	'
	[Column(Name = "'+OriginalColumnName+'")]' ELSE '' END +
...
(
    SELECT 
        ...
        CASE idx.is_primary_key
			WHEN 1 THEN '[PrimaryKey('+CASE col.is_identity WHEN 1 THEN 'KeyTypeEnum.Auto' ELSE 'KeyTypeEnum.Manual' END+')]'
			ELSE NULL
